...
function gmat_sp_get_lesson_keys() {
    $keys = array(
        ...
        'cr_lesson_1'    => array('label' => 'CR Lesson 1: Intro to CR',  'section' => 'CR Lessons',   'xapi_slug' => 'intro-to-cr',
        ...
        'cr_lesson_2'    => array('label' => 'CR Lesson 2: Deconstructing Arguments',  'section' => 'CR Lessons',   'xapi_slug' => 'deconstructing-arguments',
        ...
        'cr_lesson_3'    => array('label' => 'CR Lesson 3: Argument Types',  'section' => 'CR Lessons',   'xapi_slug' => 'cr-argument-types-lesson',
        ...
        'cr_lesson_4'    => array('label' => 'CR Lesson 4: Assumption Family Question Types',  'section' => 'CR Lessons',   'xapi_slug' => 'assumption-family-question-types-lesson',
        ...
        'cr_lesson_5'    => array('label' => 'CR Lesson 5: Plan Arguments',  'section' => 'CR Lessons',   'xapi_slug' => 'plan-arguments-lesson',
        ...
        'cr_lesson_6'    => array('label' => 'CR Lesson 6: Regular Arguments',  'section' => 'CR Lessons',   'xapi_slug' => 'regular-arguments-lesson',
        ...
        'cr_lesson_7'    => array('label' => 'CR Lesson 7: Explanation Arguments',  'section' => 'CR Lessons',   'xapi_slug' => 'explanation-arguments-lesson',
        ...
        'cr_lesson_8'    => array('label' => 'CR Lesson 8: The Structure Family',  'section' => 'CR Lessons',   'xapi_slug' => 'structure-family-lesson',
            'topic' => 'CR Describe the Role',
            'desc' => "Learn how to analyze the logical structure of CR arguments independent of content"),
        'cr_lesson_9'    => array('label' => 'CR Lesson 9: The Evidence Family ',  'section' => 'CR Lessons',   'xapi_slug' => 'evidence-family-lesson',
        ...
        'cr_exercise_3'  => array('label' => 'CR Exercise 3: Argument Types', 'section' => 'CR Exercises', 'xapi_slug' => 'cr-argument-types-learning-exercise-fix',
            'topic' => 'Classifying CR Argument Types',
            'desc' => "Practice classifying CR arguments"),
        'cr_exercise_4'  => array('label' => 'CR Exercise 4: Plan Arguments', 'section' => 'CR Exercises', 'xapi_slug' => 'plan-arguments-learning-exercise',
        ...
        'cr_exercise_7'  => array('label' => 'CR Exercise 7: The Structure Family', 'section' => 'CR Exercises', 'xapi_slug' => 'structure-family-learning-exercise',
        ...
        'cr_exercise_8'  => array('label' => 'CR Exercise 8: The Evidence Family', 'section' => 'CR Exercises', 'xapi_slug' => 'evidence-family-learning-exercise',
        ...
        'rc_lesson_1'    => array('label' => 'RC Lesson 1: Intro to RC',   'section' => 'RC Lessons',   'xapi_slug' => 'intro-to-rc',
        ...
        'rc_lesson_2'    => array('label' => 'RC Lesson 2: Question Types',   'section' => 'RC Lessons',   'xapi_slug' => 'rc-question-types',
            'topic' => 'RC Question Types',
            'desc' => "Learn the major RC question types and how your strategy should change for each"),
        'rc_lesson_3'    => array('label' => 'RC Lesson 3: Language Patterns',   'section' => 'RC Lessons',   'xapi_slug' => 'rc-language-patterns',
        ...
        'pss_lesson_1'   => array('label' => 'Problem Solving Strategies Lesson 1', 'section' => 'PSS Lessons', 'xapi_slug' => 'problem-solving-strategies-lesson-1-copy',
            ...
            'desc' => "Smart Numbers\n\tLearn when and how to replace variables with smart numbers to simplify problems without changing the underlying logic\nWorking Backwards\n\tLearn how to work backwards from the answer choices and reverse the problem to save time and avoid unnecessary algebra\nOptional\n\tQuant Fundamentals: Mental Math Tricks\n\t\tBuild mental math shortcuts that reduce calculation time and help you stay focused on strategy rather than arithmetic"),
        'pss_lesson_2'   => array('label' => 'Problem Solving Strategies Lesson 2', 'section' => 'PSS Lessons', 'xapi_slug' => 'problem-solving-strategies-lesson-2-copy',
            'topic' => 'Estimation',
            'desc' => "Estimation\n\tLearn how to approximate intelligently to eliminate answer choices and save time without sacrificing accuracy"),
        ...
        'algebra_1'      => array('label' => 'Algebra Lesson 1', 'section' => 'Algebra', 'xapi_slug' => 'algebra-lesson-1-copy',
            ...
            'desc' => "Exponents and Roots\n\tLearn how to rewrite expressions with common bases to compare, simplify, or combine exponential terms efficiently\n\tLearn how factoring can simplify exponential expressions and help prevent algebraic mistakes\nLinear Equations\n\tLearn how to leverage elimination to avoid GMAT computation traps\n\tLearn how to save time and mental energy by solving for expressions involving multiple variables without fully solving for each variable\nOptional\n\tQuant Fundamentals: Exponents\n\t\tReinforce core exponent rules so you can recognize patterns and avoid common traps under time pressure\n\tQuant Fundamentals: Linear Equations\n\t\tStrengthen foundational equation-solving skills to improve speed and accuracy in more complex algebra problems"),
        'algebra_2'      => array('label' => 'Algebra Lesson 2', 'section' => 'Algebra', 'xapi_slug' => 'algebra-lesson-2-copy',
            ...
            'desc' => "Exponents & Roots\n\tLearn how to compare radical expressions\nQuadratics\n\tLearn how to factor and expand quadratic expressions efficiently while avoiding common algebra traps\n\tLearn the most common quadratic forms the GMAT tests and how to recognize them quickly\n\tLearn how to identify and apply the difference of squares to simplify and solve quadratic expressions\nInequalities\n\tLearn how solving inequalities differs from solving equations, including how sign changes affect solutions\nOptional\n\tQuant Fundamentals: Radicals and Quadratics\n\t\tReinforce core radical and quadratic rules so you can recognize structure instead of relying on computation"),
        'algebra_3'      => array('label' => 'Algebra Lesson 3', 'section' => 'Algebra', 'xapi_slug' => 'algebra-lesson-3-copy',
            'topic' => 'Formulas, Functions, & Sequences',
            'desc' => "Formulas, Functions, & Sequences\n\tLearn how to interpret and manipulate formulas, function notation, and sequences without overcomplicating the algebra"),
        'algebra_4'      => array('label' => 'Algebra Lesson 4', 'section' => 'Algebra', 'xapi_slug' => 'algebra-lesson-4-copy',
            'topic' => 'Inequalities & Quadratics',
            'desc' => "Inequalities\n\tLearn how to use elimination to combine inequalities and identify valid solution ranges efficiently\nQuadratics\n\tLearn how to eliminate variables in quadratic systems to solve for multi-variable expressions without fully solving each variable"),
        'algebra_5'      => array('label' => 'Algebra Lesson 5', 'section' => 'Algebra', 'xapi_slug' => 'algebra-lesson-5-copy',
            'topic' => 'Exponents & Roots',
            'desc' => "Exponents & Roots\n\tLearn how to use conjugates to simplify radical expressions and eliminate irrational denominators"),

        // ── Word Problems ──
        'word_problems_1' => array('label' => 'Word Problems Lesson 1', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-1-copy',
            'topic' => 'Translations',
            'desc' => "Translations\n\tLearn how to model money-based problems using clear algebraic structures\n\tLearn how to translate fuel relationships into solvable equations efficiently\nOptional\n\tQuant Fundamentals: Translations\n\t\tPractice converting common word patterns into equations to reduce setup errors and hesitation"),
        'word_problems_2' => array('label' => 'Word Problems Lesson 2', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-2-copy',
            ...
            'desc' => "Combined Rates\n\tLearn how to organize complex rate information using a rate table to simplify multi-step problems\n\tLearn how to model and solve problems involving multiple rates working together or in opposition\nTwo Overlapping Sets\n\tLearn how to use the double-set matrix to track overlapping quantities accurately\n\tLearn how the GMAT disguises overlapping sets problems through misleading or incomplete wording"),
        'word_problems_3' => array('label' => 'Word Problems Lesson 3', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-3-copy',
            'topic' => 'Rates - Changing Workers, Rates - Average Speed, Combinatorics',
            'desc' => "Rates - Changing Workers\n\tLearn how adding or removing workers affects total time and productivity in multi-step rate problems\nRates - Average Speed\n\tLearn how to correctly calculate average speed in multi-leg journeys without falling for common traps\nCombinatorics\n\tLearn how to determine whether the order in which selections are made affects the total number of possible combinations"),
        'word_problems_4' => array('label' => 'Word Problems Lesson 4', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-4-copy',
            ...
            'desc' => "Statistics - Average/Sum\n\tLearn how averages relate to totals and how to manipulate one to solve for the other efficiently\nStatistics - Median\n\tLearn how to reason about medians in both ordered and partially defined data sets\nEvenly-Spaced Sets\n\tLearn how to recognize evenly spaced number sets and use shortcut formulas to find sums and averages quickly"),
        'word_problems_5' => array('label' => 'Word Problems Lesson 5', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-5-copy',
            ...
            'desc' => "Statistics - Weighted Averages\n\tLearn how to use the tug-of-war diagram to solve mixture and two-part weighted average problems intuitively\n\tLearn how to identify problems that test weighted averages even when the language does not mention averages explicitly\nStatistics - Standard Deviation\n\tLearn how to compare and reason about standard deviation using spread and symmetry instead of calculating exact values\nThree Overlapping Sets\n\tLearn how to use structured formulas to track three overlapping sets accurately without losing or double-counting elements"),
        'word_problems_6' => array('label' => 'Word Problems Lesson 6', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-6-copy',
            ...
            'desc' => "Combinatorics\n\tLearn when complex combinatorics problems should be split into separate cases and solved by adding results\n\tLearn when complex combinatorics problems should be split into stages and solved by multiplying outcomes\nProbability\n\tLearn how to calculate probabilities involving multiple events while tracking dependencies correctly\n\tLearn how to combine counting techniques with probability to solve advanced GMAT probability questions\nUnit Conversions\n\tLearn how to convert units directly using a single conversion factor without introducing unnecessary steps\n\tLearn how to handle multi-step unit conversions systematically to avoid compounding errors"),
        'word_problems_7' => array('label' => 'Word Problems Lesson 7', 'section' => 'Word Problems', 'xapi_slug' => 'word-problems-lesson-7-copy',
            ...
            'desc' => "Probability & Combinatorics\n\tLearn how to count or calculate probability when success can occur through more than one valid outcome\n\tLearn how to solve \"at least\" problems efficiently by reframing them using complements\nStatistics - Min/Max\n\tLearn how to determine feasible minimum and maximum values using constraints and logical bounds"),
        ...
        'number_props_1'  => array('label' => 'Number Properties Lesson 1', 'section' => 'Number Properties', 'xapi_slug' => 'number-properties-lesson-1-copy',
            ...
            'desc' => "Divisibility & Primes\n\tLearn how to break numbers into prime factors to analyze divisibility\n\tLearn how to recognize square and cube structures that simplify exponent, root, and divisibility problems\n\tLearn how the GMAT disguises straightforward number property questions using misleading wording\nOptional\n\tQuant Fundamentals: Prime Factoring\n\t\tReinforce prime factorization techniques so you can recognize structure instead of brute-forcing calculations"),
        'number_props_2'  => array('label' => 'Number Properties Lesson 2', 'section' => 'Number Properties', 'xapi_slug' => 'number-properties-lesson-2-copy',
            ...
            'desc' => "Divisibility & Primes (Remainders)\n\tLearn how remainders interact with divisibility in GMAT-style number property questions"),
        ...
        'fprs_1'          => array('label' => 'FPRs Lesson 1', 'section' => 'FPRs', 'xapi_slug' => 'fractions-percents-and-ratios-lesson-1-copy',
            ...
            'desc' => "Percents\n\tLearn how to translate percent language into equations quickly and accurately\nOptional\n\tQuant Fundamentals: Percent Translations\n\t\tReinforce percent-to-equation conversions to reduce setup errors and improve speed"),
        'fprs_2'          => array('label' => 'FPRs Lesson 2', 'section' => 'FPRs', 'xapi_slug' => 'fractions-percents-and-ratios-lesson-2-copy',
            ...
            'desc' => "Fractions\n\tLearn when cross multiplication is valid and how to apply it without introducing algebraic errors\n\tLearn advanced fraction manipulations, including splitting and restructuring expressions to simplify complex equations\nRatios\n\tLearn how to use the unknown multiplier method to translate ratios into solvable algebraic equations"),
        ...
        'quant_exercise_3' => array('label' => 'Quant Exercise 3', 'section' => 'Quant Exercises', 'xapi_slug' => 'quant-learning-exercise-3-publish',
            ...
            'desc' => "\tApply Unit 4 Quant strategies under realistic time pressure, with personalized tutor support targeting your specific breakdowns\nSkills Covered\n\tAlgebra: Formulas, Functions, & Sequences\n\tWord Problems: Rates - Changing Workers & Average Speed, Statistics - Average/Sum & Median, Evenly-Spaced Sets, Combinatorics\n\tFPRs: Fractions, Ratios"),
        ...
        // Course-level intro
        'course_intro' => array('label' => 'Course Introduction', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/gurutor-course-intro.pdf',
            'topic' => 'Welcome & Platform Overview (PDF)',
            'desc' => ''),

        // Practice Tests (one per section end)
        'practice_test_1' => array('label' => 'Practice Test 1', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/gurutor-pre-practice-test-1.pdf',
            'topic' => 'Pre-Practice Test 1 (PDF)',
            'desc' => ''),
        'practice_test_2' => array('label' => 'Practice Test 2', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/gurutor-pre-practice-test-2.pdf',
            'topic' => 'Pre-Practice Test 2 (PDF)',
            'desc' => ''),
        'practice_test_3' => array('label' => 'Practice Test 3', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/gurutor-pre-practice-test-3.pdf',
            'topic' => 'Pre-Practice Test 3 (PDF)',
            'desc' => ''),

        // Quant Fundamentals — Lessons (Group A, used in Verbal Unit 1 review)
        'qf_mental_math_lesson' => array('label' => 'Quant Fundamentals: Mental Math Tricks', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorMentalMathTricks_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_fractions_lesson' => array('label' => 'Quant Fundamentals: Fractions', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorFractions_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_linear_equations_lesson' => array('label' => 'Quant Fundamentals: Linear Equations', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorLinearEquations_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_prime_factoring_lesson' => array('label' => 'Quant Fundamentals: Prime Factoring', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorPrimeFactoring_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_translations_lesson' => array('label' => 'Quant Fundamentals: Translations', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorTranslations_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),

        // Quant Fundamentals — Lessons (Group B, used in Verbal Unit 2 review)
        'qf_percent_translations_lesson' => array('label' => 'Quant Fundamentals: Percent Translations', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorPercentTranslations_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_exponents_lesson' => array('label' => 'Quant Fundamentals: Exponents', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorExponents_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_radicals_quadratics_lesson' => array('label' => 'Quant Fundamentals: Simplifying Radicals & Quadratics', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorSimplifyingRadicals_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),
        'qf_roots_lesson' => array('label' => 'Quant Fundamentals: Roots', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/GurutorRoots_Lesson.pdf',
            'topic' => 'Lesson (PDF)',
            'desc' => ''),

        // Quant Fundamentals — Problem Sets (Group A, used in Verbal Units 3 & 5 review)
        'qf_mental_math_practice' => array('label' => 'Quant Fundamentals: Mental Math Tricks — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/MentalMathTricks_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_fractions_practice' => array('label' => 'Quant Fundamentals: Fractions — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/Fractions_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_linear_equations_practice' => array('label' => 'Quant Fundamentals: Linear Equations — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/LinearEquations_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_prime_factoring_practice' => array('label' => 'Quant Fundamentals: Prime Factoring — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/PrimeFactoring_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_translations_practice' => array('label' => 'Quant Fundamentals: Translations — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
        ...
        'qf_percent_translations_practice' => array('label' => 'Quant Fundamentals: Percent Translations — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/PercentTranslations_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_exponents_practice' => array('label' => 'Quant Fundamentals: Exponents — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/Exponents_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_radicals_quadratics_practice' => array('label' => 'Quant Fundamentals: Simplifying Radicals & Quadratics — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
            'pdf_path' => '2026/05/SimplifyingRadicals_Quadratics_Extended_Practice.pdf',
            'topic' => 'Problem Set (PDF)',
            'desc' => ''),
        'qf_roots_practice' => array('label' => 'Quant Fundamentals: Roots — Problem Set', 'section' => 'Resources', 'type' => 'pdf',
